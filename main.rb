...
def scrape(id)
  ...
  begin
    ...
    record = {}
    app_title_css_path = 'html body.no-focus-outline div.exports-controller div#wrapper.wrapper-with-footer div#body-content div.outer-container div.inner-container div.main-content div div.details-wrapper.apps.square-cover.id-track-partial-impression.id-deep-link-item div.details-info div.info-container div.info-box-top h1.document-title div.id-app-title'
    app_images_css_path = 'html body.no-focus-outline div.exports-controller div#wrapper.wrapper-with-footer div#body-content div.outer-container div.inner-container div.main-content div div.details-wrapper.apps.square-cover.id-track-partial-impression.id-deep-link-item div.details-section.screenshots div.details-section-contents div.details-section-body.expandable div.thumbnails-wrapper div.thumbnails img.screenshot'
    app_desc_css_path = 'html body.no-focus-outline div.exports-controller div#wrapper.wrapper-with-footer div#body-content div.outer-container div.inner-container div.main-content div div.details-wrapper.apps.square-cover.id-track-partial-impression.id-deep-link-item div.details-section.description.simple.contains-text-link.apps-secondary-color div.details-section-contents.show-more-container.apps-description div div.show-more-content.text-body'
    app_suggest_app_css_path = 'html body.no-focus-outline div.exports-controller div#wrapper.wrapper-with-footer div#body-content div.outer-container div.inner-container div.secondary-content div.details-wrapper div.details-section.recommendation div.details-section-contents div.rec-cluster div.cards div.card.no-rationale.square-cover.apps.medium-minus div.card-content.id-track-click.id-track-impression div.details a.title'
    app_update_css_path = 'html body.no-focus-outline div.exports-controller div#wrapper.wrapper-with-footer div#body-content div.outer-container div.inner-container div.main-content div.details-wrapper.apps-secondary-color div.details-section.metadata div.details-section-contents div.meta-info div.content'

    page.css(app_title_css_path).each do |el|
      record["title"] = el.text
    end
